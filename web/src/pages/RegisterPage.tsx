      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-600 to-primary-800 items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <h1 className="text-3xl font-bold mb-4 leading-tight">
            Stop guessing on price. Start closing with confidence.
          </h1>
          <p className="text-primary-100 text-lg leading-relaxed">
            QuotePro gives cleaning business owners the tools to quote faster,
            follow up smarter, and grow revenue — without working more hours.
          </p>
          <div className="mt-8 space-y-3">
            {[
              "Set up your first quote in under 5 minutes",
              "No credit card required to start",
              "Free tier included — upgrade when you're ready",
            ].map((item) => (
