      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-600 to-primary-800 items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <h1 className="text-3xl font-bold mb-4 leading-tight">
            Your quotes are ready. Your follow-ups are running. Let's go.
          </h1>
          <p className="text-primary-100 text-lg leading-relaxed">
            QuotePro is built for cleaning business owners who want to close faster, charge more, and grow on purpose.
          </p>
          <div className="mt-8 space-y-3">
            {[
              "Good/Better/Best quotes in under 60 seconds",
              "AI follow-ups that close jobs while you work",
              "Track every lead, customer, and dollar",
            ].map((item) => (
