...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel — dark, trust-building (matches register page) */}
        ...
        <div className="flex-1 flex items-center justify-center px-6 lg:px-12 py-10">
          <div className="w-full max-w-[440px]">
            <div className="mb-8">
              ...
              <p className="text-slate-500 text-sm mt-1.5">Welcome back. Let's close some jobs.</p>
            </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className="w-full h-[44px] px-3.5 rounded-xl border border-slate-300 bg-white text-slate-900 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/25 focus:border-blue-500 transition-all"
                  />
                </div>
                <div>
