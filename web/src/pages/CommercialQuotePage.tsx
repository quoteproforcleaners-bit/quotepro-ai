...
function FieldTogglePanel({ hidden, onToggle, onClose }: {
 ...
 <div
 className="mt-16 mr-4 w-72 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden"
 onClick={(e) => e.stopPropagation()}
 >
 <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-slate-50">
 <div className="flex items-center gap-2">
 <Eye className="w-4 h-4 text-slate-500"/>
 <span className="text-sm font-semibold text-slate-700">Field Visibility</span>
 </div>
 ...
 <span className={`text-xs ${isHidden ?"text-slate-400 line-through":"text-slate-600"}`}>{label}</span>
 <button
 type="button"
