...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: React.ElementType }> = {
 active: { label:"Active", color:"text-green-600", icon: Play },
 paused: { label:"Paused", color:"text-yellow-600", icon: Pause },
 completed: { label:"Completed", color:"text-blue-600", icon: CheckCircle },
 cancelled: { label:"Cancelled", color:"text-slate-400", icon: X },
};
...
export default function EmailSequencesPage() {
 ...
 <p className="text-sm text-slate-500 mt-0.5">Campaigns</p>
 </div>
 </Card>
 <Card>
 <div className="p-4 text-center">
 ...
 <div className="w-0.5 h-full bg-slate-200 mt-1 mb-1 min-h-4"/>
 )}
 </div>
 <div className="flex-1 pb-3">
 <div className="flex items-center gap-2 flex-wrap mb-1">
 <p className="font-medium text-sm text-slate-800">{step.subject}</p>
 ...
 className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded-lg bg-white text-slate-800 placeholder-slate-400 text-sm"
 />
 </div>
 ...
 <p className="text-sm text-slate-500">{enrollment.customerEmail}</p>
 ...
 <div>
 <h3 className="font-semibold text-slate-800">Enroll in Campaign</h3>
 <p className="text-sm text-slate-500 mt-0.5">{enrollModal.name}</p>
 </div>
 <button
 ...
 className="w-full px-3 py-2 border border-slate-200 rounded-lg bg-white text-slate-800 placeholder-slate-400 text-sm"
 />
 </div>
 ...
 <div>
 <h3 className="text-base font-semibold text-slate-900">Send Next Email</h3>
 <p className="text-sm text-slate-500 mt-0.5">To: {sendNextModal.customerName}</p>
 </div>
 <button
 ...
 <p className="text-xs font-medium text-slate-500 mb-2">Attachments (optional)</p>
