...
export function WalkthroughOverlay() {
 ...
 <h2 className="text-[19px] font-bold text-slate-900 mb-2.5 leading-snug">
 {step.title}
 </h2>
 ...
 className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-slate-400 hover:text-slate-600 disabled:opacity-0 disabled:pointer-events-none transition-all rounded-lg hover:bg-slate-50"
 >
 ...
 <button
 onClick={skipTour}
 className="px-3 py-2 text-sm font-medium text-slate-400 hover:text-slate-600 transition-colors rounded-lg hover:bg-slate-50"
 >
 Skip
 </button>
 ) : null}
