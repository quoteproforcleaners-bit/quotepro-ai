  ...
  return (
    <div className="mx-3 mb-2">
      <a
        ...
        className="flex items-center gap-2 px-2.5 py-2 rounded-xl bg-black dark:bg-slate-950 border border-slate-700 dark:border-white/10 hover:opacity-85 transition-opacity"
      >
      ...
      <div className="mt-1.5 flex flex-col items-center gap-1 px-1">
        <a
          ...
          className="rounded-xl overflow-hidden border border-slate-200 dark:border-white/10 hover:opacity-85 transition-opacity"
        >
