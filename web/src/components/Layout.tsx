  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex">
      ...
      >
        ...
        <div className="mx-3 mb-2 flex items-stretch gap-2">
          <a
            href="https://apps.apple.com/us/app/quotepro-ai-cleaning-quotes/id6758575812"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 flex-1 min-w-0 px-2.5 py-2 rounded-xl bg-black dark:bg-slate-950 border border-slate-700 dark:border-white/10 hover:opacity-85 transition-opacity"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            title="Scan to download QuotePro on iOS"
            className="shrink-0 rounded-xl overflow-hidden border border-slate-700 dark:border-white/10 hover:opacity-85 transition-opacity bg-white"
          >
            <img
              src="https://api.qrserver.com/v1/create-qr-code/?size=56x56&margin=4&data=https://apps.apple.com/us/app/quotepro-ai-cleaning-quotes/id6758575812"
              alt="QR code to download QuotePro"
              width={56}
              height={56}
              style={{ display: "block" }}
            />
