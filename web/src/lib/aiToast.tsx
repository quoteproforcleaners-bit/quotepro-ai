    ...
    <AIToastContext.Provider value={{ showAIError, clearAIError }}>
      ...
      {toast.visible && (
        <div className="fixed bottom-6 right-6 z-[9999] animate-slide-up">
          <div className="bg-zinc-900 dark:bg-zinc-800 border border-zinc-700 text-white px-4 py-3 rounded-xl shadow-xl text-sm font-medium flex items-center gap-3 max-w-sm">
