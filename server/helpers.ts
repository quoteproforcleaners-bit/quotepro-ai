...
export async function jobberGQL(token: string, query: string, variables?: Record<string, any>) {
...
// ─── jobberGetOrCreateClient ────────────────────────────────────────────

export async function jobberGetOrCreateClient(token: string, customer: { name?: string; email?: string; phone?: string }) {
...
// ─── jobberGetOrCreateProperty ────────────────────────────────────────────

export async function jobberGetOrCreateProperty(token: string, clientId: string, addressStr?: string | null) {
...
export async function initJobberTables() {
  try {
    await pool.query(`
